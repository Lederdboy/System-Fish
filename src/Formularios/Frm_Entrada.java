...
public class Frm_Entrada extends javax.swing.JInternalFrame {
    ...
    private void llenarComboBox(){
        ArrayList<Proveedores> listaProveedores = CP.rellenarComboBox();        
        Cbo_Prov.removeAllItems();
        for (int i = 0; i < listaProveedores.size(); i++) {
            Cbo_Prov.addItem(new Proveedores(listaProveedores.get(i).getRuc(), listaProveedores.get(i).getNombre()));
        }
    }
    ...
    private void limpiar(){
        ...
        Cbo_Prov.setSelectedItem("");
        txt_descripcion.setText("");
        txt_nfactura.requestFocus();
        jtb_entrada.clearSelection();
    }

    private void guardar(long ruc){
        ...
        if(num == 0){
            int respuesta = CP.registrarEntrada(nfac,codigo,fecha_sql,cantidad,ruc);
            int respuesta2 = CP.registrarMovimiento("Entrada",nfac,codigo);
    ...
    private void initComponents() {
        ...
        Cbo_Prov = new javax.swing.JComboBox<>();
        ...
        Cbo_Prov.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Cbo_ProvActionPerformed(evt);
            }
        });
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            ...
                                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                ...
                                                .addComponent(Cbo_Prov, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Cbo_Prov, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jbt_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbt_guardarActionPerformed
        long ruc = Cbo_Prov.getItemAt(Cbo_Prov.getSelectedIndex()).getRuc();                                   
        guardar(ruc);
    }//GEN-LAST:event_jbt_guardarActionPerformed

    private void Cbo_ProvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Cbo_ProvActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Cbo_ProvActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<Proveedores> Cbo_Prov;
