...
public class Frm_Salida extends javax.swing.JInternalFrame {
    ...
    private void llenarComboBox(){
        ArrayList<Clientes> listaClientes = CP.rellenarComboBox();        
        Cbo_Salida.removeAllItems();
        for (int i = 0; i < listaClientes.size(); i++) {
            Cbo_Salida.addItem(new Clientes(listaClientes.get(i).getNro_documento(), listaClientes.get(i).getNombre()));
        }
    }
    ...
    private void guardar(int nroDoc){
        ...
        if(cantidad > stock){
            ...
            if(num == 0){
                int respuesta = CP.registrarSalida(nfac,codigo,fecha_sql,cantidad, nroDoc);
                int respuesta2 = CP.registrarMovimiento("Salida",nfac,codigo);
    ...
    private void initComponents() {
        ...
        Cbo_Salida = new javax.swing.JComboBox<>();
        ...
        Cbo_Salida.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Cbo_SalidaActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addComponent(Cbo_Salida, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))))))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel9)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(Cbo_Salida, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(jLabel3)
    ...
    private void jbt_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbt_guardarActionPerformed
        Integer nroDoc = Cbo_Salida.getItemAt(Cbo_Salida.getSelectedIndex()).getNro_documento();
        guardar(nroDoc);
    }//GEN-LAST:event_jbt_guardarActionPerformed

    private void Cbo_SalidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Cbo_SalidaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_Cbo_SalidaActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JComboBox<Clientes> Cbo_Salida;
