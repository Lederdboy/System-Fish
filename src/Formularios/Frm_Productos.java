...
import static Formularios.Frm_Entrada.txt_cantidad;
...
public class Frm_Productos extends javax.swing.JInternalFrame {
    ...
    private void guardar(){
        ...
        Double precio_unit = Double.parseDouble(txt_precio.getText());
    
    
        if(num == 0){
            int respuesta = CP.registrarProducto(codigo,descripcion, precio_unit);
            if(respuesta > 0){
        ...
        if (row >= 0) {
            ...
            int respuesta = CP.actualizarProducto(codigo, descripcion, precio_unit, codigo_old);
            if (respuesta > 0) {
                listar();
                limpiar();
                iniciar();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txt_descripcion, javax.swing.GroupLayout.PREFERRED_SIZE, 459, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
